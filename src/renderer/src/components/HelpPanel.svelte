  ...
  <div class="modal-overlay" onclick={handleOverlayClick} role="dialog">
    <div class="modal-box">
      ...
      <div class="section">
        ...
        <div class="shortcut"><kbd>{mod}+Click</kbd> file to open side-by-side (up to 3)</div>
        <div class="shortcut"><kbd>+</kbd> button to create a new file</div>
        <div class="shortcut"><kbd>Right-click</kbd> file for status, quality, rename, delete</div>
      </div>
      ...
      <div class="section">
        ...
        <div class="shortcut"><kbd>{mod}+Shift+Z</kbd> / <kbd>{mod}+Y</kbd> Redo</div>
      ...
      <div class="section">
        ...
        <div class="shortcut"><kbd>{mod}+1</kbd> / <kbd>2</kbd> / <kbd>3</kbd> Heading 1 / 2 / 3</div>
        <div class="shortcut"><kbd>{mod}+K</kbd> Insert link</div>
        <div class="shortcut"><kbd>{mod}+Enter</kbd> Poetry line break (trailing \)</div>
        ...
        <div class="shortcut"><kbd>Shift+F3</kbd> Cycle case: UPPER / Title / lower</div>
      </div>

      <div class="section">
        <h3>Multi-Pane</h3>
        <p class="hint">{mod}+Click on a file opens it side-by-side. Up to 3 panes can be open. Click into a pane to make it active — all shortcuts apply to the active pane. Multi-pane locks to edit-only view.</p>
      </div>
    </div>
  </div>
{/if}
...
<style>
  ...
  .shortcut {
    font-size: .82rem; padding: .2rem 0; color: var(--text);
    display: flex; align-items: center; gap: .3rem;
  }
  kbd {
    background: var(--bg); border: 1px solid var(--border);
    border-radius: 3px; padding: 1px 6px; font-size: .72rem;
